...
namespace CalculadoraProyecto1
{
    public partial class Form1 : Form
    {
        ...
        ClasesCalculadora.ClaseSuma objeto1 = new ClasesCalculadora.ClaseSuma();
        ClasesCalculadora.ClaseResta objeto2 = new ClasesCalculadora.ClaseResta();
        ClasesCalculadora.ClaseMultiplicacion objeto3 = new ClasesCalculadora.ClaseMultiplicacion();
        ClasesCalculadora.ClaseDivision objeto4 = new ClasesCalculadora.ClaseDivision();
        ClasesCalculadora.ClasePorcentaje objeto5 = new ClasesCalculadora.ClasePorcentaje();
        ClasesCalculadora.ClaseFactorial objeto6 = new ClasesCalculadora.ClaseFactorial();
        ...
        private void btnfactorial_Click(object sender, EventArgs e)
        {
            ...
            txtresultado.Text = Factor.ToString();
        }
